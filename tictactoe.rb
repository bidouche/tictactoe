...
class Board
  ...
  def initialize
    @board = []
    i = 0
    #je crée mes instances de BordCase
    while (i < 10)
  ...
  def victory?
    #dans win_comb je rentre toutes les possibilités de gagner
  ...
  puts plate 
    if (i%2 == 0)
      ...
      @player1_plays << input # je pousse les réponses du joueur dans un array pour le comparer a mon array de la méthode victory?
